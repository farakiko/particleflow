...
from pyg.training_jet import override_config, train_mlpf
...
def main():
    ...
    if args.train:
        ...
        #####################
        """
        define the train/valid loaders from the pt files stored in /jetdataset/clic_edm_ttbar_pf/train/
        """
